            ...
            <div style={{ flex: "1 1 50%", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
                <div style={{ width: "100%", maxWidth: "440px" }}>
                        ...
                        <div style={{ marginBottom: "24px" }}>
                            ...
                            <div style={{ position: "relative" }}>
                                <input
                                    ...
                                    onBlur={(e) => { e.currentTarget.style.borderColor = "var(--gray-800)"; e.currentTarget.style.background = "rgba(255,255,255,0.03)"; }}
                                />
                                <button type="button" style={{ position: "absolute", right: "16px", top: "50%", transform: "translateY(-50%)", background: "none", border: "none", color: "var(--gray-500)", cursor: "pointer" }}>
                    ...
                    <div style={{ display: "flex", gap: "16px" }}>
                        <button style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", padding: "14px", background: "transparent", border: "1px solid var(--gray-800)", borderRadius: "12px", color: "white", fontSize: "14px", fontWeight: 600, cursor: "pointer", transition: "background 0.2s" }} onMouseEnter={e => e.currentTarget.style.background = "rgba(255,255,255,0.05)"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
